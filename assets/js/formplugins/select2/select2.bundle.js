                ...
                return {
                    ...
                    inputTooLong: function(e) {
                        var t = e.input.length - e.maximum,
                            n = "Borra " + t + " caracteres";
                        return 1 != t && (n += "s"), n
                    },
                    inputTooShort: function(e) {
                        return "Ingresa " + (e.minimum - e.input.length) + " o mas caracteres"
                    },
                    loadingMore: function() {
                        return "Cargando mas resultados…"
                    },
                    maximumSelected: function(e) {
                        var t = "Solo puedes seleccionar  " + e.maximum + " opciones";
                    ...
                    removeAllItems: function() {
                        return "Borrar todos las opciones"
                    }
                }
