...
var initApp = function(e) {
  return e.listFilter = function(t, e, o) {
    ...
    initApp.playSound(myapp_config.assetsUrl + "/media/sound", "messagebox"), $(".js-modal-settings").modal("hide"), "undefined" != typeof bootbox ? bootbox.confirm({
    ...
    } else console.log("ERROR: You must specify the class you need to remove")
    ...
    if ($.fn.navigation) return $(e).navigation({
      ...
      if (void 0 !== $.fn.dropdown ? Popper.Defaults.modifiers.computeStyle.gpuAcceleration = !1 : console.log("OOPS! bs.popover is not loaded"), $(document).on("click", ".dropdown-menu:not(.js-auto-close):not(.note-dropdown-menu)", function(e) {
        e.stopPropagation()
        ...
        switch (!0) {
          ...
          "undefined" != typeof bootbox ? (initApp.playSound(myapp_config.assetsUrl + "/media/sound", "messagebox"), bootbox.confirm({
