(function() {
  ...
  var l, c, e, n, r, i, o, s, a, b, u, h, y, f, p, d, g, _, w, m, v, x, C, E, T, S, k, P, N, D, A, I, O, L, j, H, M, q, R, B, F, W, z, U, Y, V, X, Q, $, K = [].slice,
    G = {}.hasOwnProperty,
  ...
  for (v = {
    ...
    }, A = window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || window.msRequestAnimationFrame, m = window.cancelAnimationFrame || window.mozCancelAnimationFrame, null == A && (A = function(t) {
      ...
      return n = N(), (i = function() {
        var t;
        return 33 <= (t = N() - n) ? (n = N(), e(t, function() {
          return A(i)
        })) : setTimeout(i, 33 - t)
      })()
    }, I = function() {
      ...
      var t, e, n, i, o, r, s;
      for (e = arguments[0], r = 0, s = (i = 2 <= arguments.length ? K.call(arguments, 1) : []).length; r < s; r++)
        if (n = i[r])
    ...
    }, o = Z, b = window.Pace || {}, window.Pace = b, x(b, o.prototype), D = b.options = x({}, v, window.paceOptions, E()), z = 0, Y = (X = ["ajax", "document", "eventLag", "elements"]).length; z < Y; z++) !0 === D[M = X[z]] && (D[M] = v[M]);
  ...
  function it() {
    ...
    if (null != B && D.ajax.trackWebSockets) {
      window.WebSocket = function(t, e) {
        var n;
        return n = null != e ? new B(t, e) : new B(t), H("socket") && r.trigger("request", {
          type: "socket",
          url: t,
          protocols: e,
          request: n
  ...
  $ = Error, t(tt, $), a = tt, et.prototype.getElement = function() {
    var t;
    if (null == this.el) {
      if (!(t = document.querySelector(D.target))) throw new a;
  ...
  }, s = nt, W = window.XMLHttpRequest, F = window.XDomainRequest, B = window.WebSocket, C = function(t, e) {
    var n, i;
    ...
    var t, e, n;
    return e = arguments[0], t = 2 <= arguments.length ? K.call(arguments, 1) : [], k.unshift("ignore"), n = e.apply(null, t), k.shift(), n
  }, b.track = function() {
    var t, e, n;
    return e = arguments[0], t = 2 <= arguments.length ? K.call(arguments, 1) : [], k.unshift("track"), n = e.apply(null, t), k.shift(), n
  }, H = function(t) {
    var e;
    ...
    return !1
  }, t(it, s), u = it, U = null, j = function(t) {
    var e, n, i, o;
    for (n = 0, i = (o = D.ajax.ignoreURLs).length; n < i; n++)
    ...
    var e, r, s, a, n;
    if (a = t.type, s = t.request, n = t.url, !j(n)) return b.running || !1 === D.restartOnRequestAfter && "force" !== H(a) ? void 0 : (r = arguments, "boolean" == typeof(e = D.restartOnRequestAfter || 0) && (e = 0), setTimeout(function() {
      var t, e, n, i, o;
    ...
    this.progress = 0, r = [], o = e = 0, i = N(), n = setInterval(function() {
      var t;
      return t = N() - i - 50, i = N(), r.push(t), r.length > D.eventLag.sampleCount && r.shift(), e = g(r), ++o >= D.eventLag.minSamples && e < D.eventLag.lagThreshold ? (s.progress = 100, clearInterval(n)) : s.progress = 3 / (e + 3) * 100
    }, 50)
  }, at.prototype.tick = function(t, e) {
    var n;
    return null == e && (e = I(this.source, "progress")), 100 <= e && (this.done = !0), e === this.last ? this.sinceLastUpdate += t : (this.sinceLastUpdate && (this.rate = (e - this.last) / this.sinceLastUpdate), this.catchup = (e - this.progress) / D.catchupTime, this.sinceLastUpdate = 0, this.last = e), e > this.progress && (this.progress += this.catchup * t), n = 1 - Math.pow(this.progress / 100, D.easeFactor), this.progress += n * this.rate * t, this.progress = Math.min(this.lastProgress + D.maxProgressPerFrame, this.progress), this.progress = Math.max(0, this.progress), this.progress = Math.min(100, this.progress), this.lastProgress = this.progress, this.progress
  }, y = at, w = d = R = _ = L = q = null, b.running = !1, S = function() {
    if (D.restartOnPushState) return b.restart()
    ...
    var t, e, n, i, o, r, s, a;
    for (b.sources = q = [], e = 0, i = (r = ["ajax", "elements", "document", "eventLag"]).length; e < i; e++) !1 !== D[t = r[e]] && q.push(new h[t](D[t]));
    for (n = 0, o = (a = null != (s = D.extraSources) ? s : []).length; n < o; n++) M = a[n], q.push(new M(D));
    return b.bar = _ = new c, L = [], R = new y
  })(), b.stop = function() {
    return b.trigger("stop"), b.running = !1, _.destroy(), w = !0, null != d && ("function" == typeof m && m(d), d = null), P()
  }, b.restart = function() {
    return b.trigger("restart"), b.stop(), b.start()
  }, b.go = function() {
    var v;
    return b.running = !0, _.render(), v = N(), w = !1, d = O(function(t, e) {
      var n, i, o, r, s, a, l, c, u, h, f, p, d, g, m;
      for (100 - _.progress, i = h = 0, o = !0, a = f = 0, d = q.length; f < d; a = ++f)
        for (M = q[a], u = null != L[a] ? L[a] : L[a] = [], l = p = 0, g = (s = null != (m = M.elements) ? m : [M]).length; p < g; l = ++p) r = s[l], o &= (c = null != u[l] ? u[l] : u[l] = new y(r)).done, c.done || (i++, h += c.tick(t));
      return n = h / i, _.update(R.tick(t, n)), _.done() || o || w ? (_.update(100), b.trigger("done"), setTimeout(function() {
  ...
  function(t, e) {
    ...
    var f = function(n) {
      ...
      function at(e, t, n, i) {
        ...
        if (!i && (x(t), t = t || C, E)) {
          if (11 !== f && (l = et.exec(e)))
            ...
            if (u = e, h = t, 1 === f && (X.test(e) || V.test(e))) {
              for ((h = nt.test(e) && vt(t.parentNode) || t) === t && p.scope || ((a = t.getAttribute("id")) ? a = a.replace(ot, rt) : t.setAttribute("id", a = T)), r = (c = d(e)).length; r--;) c[r] = (a ? "#" + a : ":scope") + " " + yt(c[r]);
              u = c.join(",")
            }
            try {
      ...
      for (t in p = at.support = {}, s = at.isXML = function(t) {
          ...
          return i != C && 9 === i.nodeType && i.documentElement && (a = (C = i).documentElement, E = !s(C), y != C && (n = C.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", o, !1) : n.attachEvent && n.attachEvent("onunload", o)), p.scope = ut(function(t) {
          ...
          if (x(t), p.matchesSelector && E && !D[e + " "] && (!u || !u.test(e)) && (!m || !m.test(e))) try {
            var n = v.call(t, e);
          ...
          preFilter: {
            ...
            PSEUDO: function(t) {
              var e, n = !t[6] && t[2];
              return K.CHILD.test(t[0]) ? null : (t[3] ? t[2] = t[4] || t[5] || "" : n && Q.test(n) && (e = d(n, !0)) && (e = n.indexOf(")", n.length - e) - n.length) && (t[0] = t[0].slice(0, e), t[2] = n.slice(0, e)), t.slice(0, 3))
            }
          },
          filter: {
            TAG: function(t) {
            ...
            ATTR: function(n, i, o) {
              return function(t) {
                var e = at.attr(t, n);
                return null == e ? "!=" === i : !i || (e += "", "=" === i ? e === o : "!=" === i ? e !== o : "^=" === i ? o && 0 === e.indexOf(o) : "*=" === i ? o && -1 < e.indexOf(o) : "$=" === i ? o && e.slice(-o.length) === o : "~=" === i ? -1 < (" " + e.replace(z, " ") + " ").indexOf(o) : "|=" === i && (e === o || e.slice(0, o.length + 1) === o + "-"))
              }
            },
          ...
          pseudos: {
            ...
            lang: ct(function(n) {
              return $.test(n || "") || at.error("unsupported lang: " + n), n = n.replace(it, h).toLowerCase(),
                function(t) {
                  var e;
                  do {
      ...
      return bt.prototype = _.filters = _.pseudos, _.setFilters = new bt, d = at.tokenize = function(t, e) {
        ...
        if (n = n || [], 1 === u.length) {
          ...
          for (o = K.needsContext.test(t) ? 0 : r.length; o-- && (s = r[o], !_.relative[a = s.type]);)
      ...
      }, p.sortStable = T.split("").sort(A).join("") === T, p.detectDuplicates = !!c, x(), p.sortDetached = ut(function(t) {
    ...
    (T.fn.init = function(t, e, n) {
      var i, o;
      if (!t) return this;
      if (n = n || N, "string" != typeof t) return t.nodeType ? (this[0] = t, this.length = 1, this) : y(t) ? void 0 !== n.ready ? n.ready(t) : t(T) : T.makeArray(t, this);
    ...
    T.fn.extend({
      ...
      contents: function(t) {
        return null != t.contentDocument && i(t.contentDocument) ? t.contentDocument : (S(t, "template") && (t = t.content || t), T.merge([], t.childNodes))
      }
    }, function(i, o) {
      T.fn[i] = function(t, e) {
        var n = T.map(this, o, t);
        return "Until" !== i.slice(-5) && (e = t), e && "string" == typeof e && (n = T.filter(e, n)), 1 < this.length && (I[i] || T.uniqueSort(n), A.test(i) && n.reverse()), this.pushStack(n)
      }
    });
    var L = /[^\x20\t\r\n\f]+/g;
    ...
    T.Callbacks = function(i) {
                ...
                return function() {
                  function t() {
                    ...
                    if (!(o < l)) {
                      ...
                      e = t && ("object" == typeof t || "function" == typeof t) && t.then, y(e) ? a ? e.call(t, c(l, r, j, a), c(l, r, H, a)) : (l++, e.call(t, c(l, r, j, a), c(l, r, H, a), c(l, r, j, r.notifyWith))) : (s !== j && (n = void 0, i = [t]), (a || r.resolveWith)(n, i))
                    }
                  }
                  var n = this,
                    i = arguments,
      ...
      when: function(t) {
        ...
        var n = arguments.length,
          ...
          r = a.call(arguments),
          s = T.Deferred();
        if (n <= 1 && (M(t, s.done(e(i)).resolve, s.reject, !n), "pending" === s.state() || y(r[i] && r[i].then))) return s.then();
    ...
    }), T.ready.then = R.then, "complete" === E.readyState || "loading" !== E.readyState && !E.documentElement.doScroll ? C.setTimeout(T.ready) : (E.addEventListener("DOMContentLoaded", B), C.addEventListener("load", B));
    ...
    T.extend({
      ...
      data: function(n, t) {
        ...
        if (void 0 !== n) return "object" == typeof n ? this.each(function() {
          ...
          var e;
          if (r && void 0 === t) return void 0 !== (e = $.get(r, n)) ? e : void 0 !== (e = J(r, n)) ? e : void 0;
          this.each(function() {
            $.set(this, n, t)
          })
        }, null, t, 1 < arguments.length, null, !0);
        if (this.length && (o = $.get(r), 1 === r.nodeType && !Q.get(r, "hasDataAttrs"))) {
          for (e = s.length; e--;) s[e] && 0 === (i = s[e].name).indexOf("data-") && (i = Y(i.slice(5)), J(r, i, o[i]));
    ...
    ct = E.createDocumentFragment().appendChild(E.createElement("div")), (ut = E.createElement("input")).setAttribute("type", "radio"), ut.setAttribute("checked", "checked"), ut.setAttribute("name", "t"), ct.appendChild(ut), b.checkClone = ct.cloneNode(!0).cloneNode(!0).lastChild.checked, ct.innerHTML = "<textarea>x</textarea>", b.noCloneChecked = !!ct.cloneNode(!0).lastChild.defaultValue, ct.innerHTML = "<option></option>", b.option = !!ct.lastChild;
    var dt = {
      thead: [1, "<table>", "</table>"],
    ...
    function bt(t, e, n, i, o) {
      ...
      for (h.textContent = "", p = 0; r = f[p++];)
        ...
        else if (c = it(r), s = gt(h.appendChild(r), "script"), c && mt(s), n)
    ...
    T.event = {
      ...
      add: function(e, t, n, i, o) {
        ...
        if (V(e))
          for (n.handler && (n = (r = n).handler, o = r.selector), o && T.find.matchesSelector(nt, o), n.guid || (n.guid = T.guid++), (l = m.events) || (l = m.events = Object.create(null)), (s = m.handle) || (s = m.handle = function(t) {
              return void 0 !== T && T.event.triggered !== t.type ? T.event.dispatch.apply(e, arguments) : void 0
            }), c = (t = (t || "").match(L) || [""]).length; c--;) p = g = (a = wt.exec(t[c]) || [])[1], d = (a[2] || "").split(".").sort(), p && (h = T.event.special[p] || {}, p = (o ? h.delegateType : h.bindType) || p, h = T.event.special[p] || {}, u = T.extend({
            type: p,
            origType: g,
            data: i,
            handler: n,
      ...
      special: {
        ...
        click: {
          setup: function(t) {
            var e = this || t;
            return ht.test(e.type) && e.click && S(e, "input") && St(e, "click", xt), !1
          },
          trigger: function(t) {
            var e = this || t;
            return ht.test(e.type) && e.click && S(e, "input") && St(e, "click"), !0
          },
          _default: function(t) {
            var e = t.target;
    ...
    function Ot(t, e) {
      ...
      if (1 === e.nodeType) {
        ...
        $.hasData(t) && (r = $.access(t), s = T.extend({}, r), $.set(e, s))
      }
    }
    ...
    function Lt(n, i, o, r) {
      ...
      var t, e, s, a, l, c, u = 0,
        ...
        p = i[0],
        d = y(p);
      if (d || 1 < h && "string" == typeof p && !b.checkClone && Pt.test(p)) return n.each(function(t) {
        var e = n.eq(t);
        d && (i[0] = p.call(this, t, e.html())), Lt(e, i, o, r)
      });
      if (h && (e = (t = bt(i, n[0].ownerDocument, !1, n, r)).firstChild, 1 === t.childNodes.length && (t = e), e || r)) {
        for (a = (s = T.map(gt(t, "script"), At)).length; u < h; u++) l = t, u !== f && (l = T.clone(l, !0, !0), a && T.merge(s, gt(l, "script"))), o.call(n[u], l, u);
        if (a)
          for (c = s[s.length - 1].ownerDocument, T.map(s, It), u = 0; u < a; u++) l = s[u], pt.test(l.type || "") && !Q.access(l, "globalEval") && T.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? T._evalUrl && !l.noModule && T._evalUrl(l.src, {
    ...
    function jt(t, e, n) {
      for (var i, o = e ? T.filter(e, t) : t, r = 0; null != (i = o[r]); r++) n || 1 !== i.nodeType || T.cleanData(gt(i)), i.parentNode && (n && it(i) && mt(gt(i, "script")), i.parentNode.removeChild(i));
      return t
    }
    T.extend({
      ...
      clone: function(t, e, n) {
        ...
        if (!(b.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || T.isXMLDoc(t)))
          for (s = gt(u), i = 0, o = (r = gt(t)).length; i < o; i++) a = r[i], l = s[i], void 0, "input" === (c = l.nodeName.toLowerCase()) && ht.test(a.type) ? l.checked = a.checked : "input" !== c && "textarea" !== c || (l.defaultValue = a.defaultValue);
        if (e)
          if (n)
            for (r = r || gt(t), s = s || gt(u), i = 0, o = r.length; i < o; i++) Ot(r[i], s[i]);
          else Ot(t, u);
    ...
    var Mt, qt, Rt, Bt, Ft, Wt, zt, Ut, Yt = new RegExp("^(" + Z + ")(?!px)[a-z%]+$", "i"),
      Vt = function(t) {
    ...
    function Qt() {
      if (Ut) {
        zt.style.cssText = "position:absolute;left:-11111px;width:60px;margin-top:1px;padding:0;border:0", Ut.style.cssText = "position:relative;display:block;box-sizing:border-box;overflow:scroll;margin:auto;border:1px;padding:1px;width:60%;top:1%", nt.appendChild(zt).appendChild(Ut);
        var t = C.getComputedStyle(Ut);
        Mt = "1%" !== t.top, Wt = 12 === $t(t.marginLeft), Ut.style.right = "60%", Bt = 36 === $t(t.right), qt = 36 === $t(t.width), Ut.style.position = "absolute", Rt = 12 === $t(Ut.offsetWidth / 3), nt.removeChild(zt), Ut = null
      }
    }
    ...
    function Kt(t, e, n) {
      ...
      return (n = n || Vt(t)) && ("" !== (s = n.getPropertyValue(e) || n[e]) || it(t) || (s = T.style(t, e)), !b.pixelBoxStyles() && Yt.test(s) && Xt.test(e) && (i = a.width, o = a.minWidth, r = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = o, a.maxWidth = r)), void 0 !== s ? s + "" : s
    }
    ...
    zt = E.createElement("div"), (Ut = E.createElement("div")).style && (Ut.style.backgroundClip = "content-box", Ut.cloneNode(!0).style.backgroundClip = "", b.clearCloneStyle = "content-box" === Ut.style.backgroundClip, T.extend(b, {
      ...
      reliableTrDimensions: function() {
        var t, e, n, i;
        return null == Ft && (t = E.createElement("table"), e = E.createElement("tr"), n = E.createElement("div"), t.style.cssText = "position:absolute;left:-11111px", e.style.height = "1px", n.style.height = "9px", nt.appendChild(t).appendChild(e).appendChild(n), i = C.getComputedStyle(e), Ft = 3 < parseInt(i.height), nt.removeChild(t)), Ft
      }
    }));
    ...
    function ae(t, e, n, i, o, r) {
      ...
      for (; s < 4; s += 2) "margin" === n && (l += T.css(t, n + et[s], !0, o)), i ? ("content" === n && (l -= T.css(t, "padding" + et[s], !0, o)), "margin" !== n && (l -= T.css(t, "border" + et[s] + "Width", !0, o))) : (l += T.css(t, "padding" + et[s], !0, o), "padding" !== n ? l += T.css(t, "border" + et[s] + "Width", !0, o) : a += T.css(t, "border" + et[s] + "Width", !0, o));
    ...
    function le(t, e, n) {
      ...
      return (!b.boxSizingReliable() && o || !b.reliableTrDimensions() && S(t, "tr") || "auto" === s || !parseFloat(s) && "inline" === T.css(t, "display", !1, i)) && t.getClientRects().length && (o = "border-box" === T.css(t, "boxSizing", !1, i), (r = a in t) && (s = t[a])), (s = parseFloat(s) || 0) + ae(t, e, n || (o ? "border" : "content"), r, i, s) + "px"
    }
    ...
    T.extend({
      ...
      style: function(t, e, n, i) {
        if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
          var o, r, s, a = Y(e),
            l = ie.test(e),
            c = t.style;
          if (l || (e = ee(a)), s = T.cssHooks[e] || T.cssHooks[a], void 0 === n) return s && "get" in s && void 0 !== (o = s.get(t, !1, i)) ? o : c[e];
          "string" === (r = typeof n) && (o = tt.exec(n)) && o[1] && (n = st(t, e, o), r = "number"), null != n && n == n && ("number" !== r || l || (n += o && o[3] || (T.cssNumber[a] ? "" : "px")), b.clearCloneStyle || "" !== n || 0 !== e.indexOf("background") || (c[e] = "inherit"), s && "set" in s && void 0 === (n = s.set(t, n, i)) || (l ? c.setProperty(e, n) : c[e] = n))
        }
      },
      css: function(t, e, n, i) {
        var o, r, s, a = Y(e);
        return ie.test(e) || (e = ee(a)), (s = T.cssHooks[e] || T.cssHooks[a]) && "get" in s && (o = s.get(t, !0, n)), void 0 === o && (o = Kt(t, e, i)), "normal" === o && e in re && (o = re[e]), "" === n || n ? (r = parseFloat(o), !0 === n || isFinite(r) ? r || 0 : o) : o
      }
    }), T.each(["height", "width"], function(t, l) {
      T.cssHooks[l] = {
        get: function(t, e, n) {
          if (e) return !ne.test(T.css(t, "display")) || t.getClientRects().length && t.getBoundingClientRect().width ? le(t, l, n) : Ht(t, oe, function() {
            return le(t, l, n)
          })
        },
        set: function(t, e, n) {
          var i, o = Vt(t),
            ...
            a = n ? ae(t, l, n, s, o) : 0;
          return s && r && (a -= Math.ceil(t["offset" + l[0].toUpperCase() + l.slice(1)] - parseFloat(o[l]) - ae(t, l, "border", !1, o) - .5)), a && (i = tt.exec(e)) && "px" !== (i[3] || "px") && (t.style[l] = e, e = T.css(t, l)), se(0, e, a)
        }
      }
    }), T.cssHooks.marginLeft = Gt(b.reliableMarginLeft, function(t, e) {
      if (e) return (parseFloat(Kt(t, "marginLeft")) || t.getBoundingClientRect().left - Ht(t, {
        marginLeft: 0
      }, function() {
      ...
      run: function(t) {
        ...
        return this.options.duration ? this.pos = e = T.easing[this.easing](t, this.options.duration * t, 0, 1, this.options.duration) : this.pos = e = t, this.now = (this.end - this.start) * e + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), n && n.set ? n.set(this) : ce.propHooks._default.set(this), this
      }
      ...
      _default: "swing"
    }, T.fx = ce.prototype.init, T.fx.step = {};
    var ue, he, fe, pe, de = /^(?:toggle|show|hide)$/,
      ge = /queueHooks$/;

    function me() {
      he && (!1 === E.hidden && C.requestAnimationFrame ? C.requestAnimationFrame(me) : C.setTimeout(me, T.fx.interval), T.fx.tick())
    }
    ...
    function _e(r, t, e) {
      var n, s, i = 0,
        ...
        l = function() {
          if (s) return !1;
          for (var t = ue || ve(), e = Math.max(0, c.startTime + c.duration - t), n = 1 - (e / c.duration || 0), i = 0, o = c.tweens.length; i < o; i++) c.tweens[i].run(n);
      ...
      for (! function(t, e) {
        ...
        if (n = _e.prefilters[i].call(c, r, u, c.opts)) return y(n.stop) && (T._queueHooks(c.elem, c.opts.queue).stop = n.stop.bind(n)), n;
      return T.map(u, ye, c), y(c.opts.start) && c.opts.start.call(r, c), c.progress(c.opts.progress).done(c.opts.done, c.opts.complete).fail(c.opts.fail).always(c.opts.always), T.fx.timer(T.extend(l, {
        elem: r,
        anim: c,
        queue: c.opts.queue
      })), c
    ...
    T.Animation = T.extend(_e, {
      ...
      tweener: function(t, e) {
        for (var n, i = 0, o = (t = y(t) ? (e = t, ["*"]) : t.match(L)).length; i < o; i++) n = t[i], _e.tweeners[n] = _e.tweeners[n] || [], _e.tweeners[n].unshift(e)
      },
      prefilters: [function(t, e, n) {
        ...
        for (i in n.queue || (null == (s = T._queueHooks(t, "fx")).unqueued && (s.unqueued = 0, a = s.empty.fire, s.empty.fire = function() {
          ...
          for (i in h && 1 === t.nodeType && (n.overflow = [d.overflow, d.overflowX, d.overflowY], null == (c = m && m.display) && (c = Q.get(t, "display")), "none" === (u = T.css(t, "display")) && (c ? u = c : (lt([t], !0), c = t.style.display || c, u = T.css(t, "display"), lt([t]))), ("inline" === u || "inline-block" === u && null != c) && "none" === T.css(t, "float") && (l || (f.done(function() {
              d.display = c
            ...
            display: c
          }), r && (m.hidden = !g), g && lt([t], !0), f.done(function() {
            for (i in g || lt([t]), Q.remove(t, "fxshow"), p) T.style(t, i, p[i])
          })), l = ye(g ? m[i] : 0, i, f), i in m || (m[i] = l.start, g && (l.end = l.start, l.start = 0))
      }],
    ...
    }, fe = E.createElement("input"), pe = E.createElement("select").appendChild(E.createElement("option")), fe.type = "checkbox", b.checkOn = "" !== fe.value, b.optSelected = pe.selected, (fe = E.createElement("input")).value = "t", fe.type = "radio", b.radioValue = "t" === fe.value;
    ...
    T.fn.extend({
      ...
      attr: function(t, e, n) {
        ...
        if (3 !== r && 8 !== r && 2 !== r) return void 0 === t.getAttribute ? T.prop(t, e, n) : (1 === r && T.isXMLDoc(t) || (o = T.attrHooks[e.toLowerCase()] || (T.expr.match.bool.test(e) ? we : void 0)), void 0 !== n ? null === n ? void T.removeAttr(t, e) : o && "set" in o && void 0 !== (i = o.set(t, n, e)) ? i : (t.setAttribute(e, n + ""), n) : o && "get" in o && null !== (i = o.get(t, e)) ? i : null == (i = T.find.attr(t, e)) ? void 0 : i)
      },
      attrHooks: {
        type: {
          set: function(t, e) {
    ...
    T.fn.extend({
      ...
      toggleClass: function(o, e) {
        ...
        return "boolean" == typeof e && s ? e ? this.addClass(o) : this.removeClass(o) : y(o) ? this.each(function(t) {
          ...
          else void 0 !== o && "boolean" != r || ((t = Se(this)) && Q.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || !1 === o ? "" : Q.get(this, "__className__") || ""))
        })
      },
      hasClass: function(t) {
        var e, n, i = 0;
        for (e = " " + t + " "; n = this[i++];)
          if (1 === n.nodeType && -1 < (" " + Te(Se(n)) + " ").indexOf(e)) return !0;
        return !1
      }
    });
    var Pe = /\r/g;
    ...
    T.extend(T.event, {
      trigger: function(t, e, n, i) {
        ...
        if (r = h = s = n = n || E, 3 !== n.nodeType && 8 !== n.nodeType && !De.test(p + T.event.triggered) && (-1 < p.indexOf(".") && (p = (d = p.split(".")).shift(), d.sort()), l = p.indexOf(":") < 0 && "on" + p, (t = t[T.expando] ? t : new T.Event(p, "object" == typeof t && t)).isTrigger = i ? 2 : 3, t.namespace = d.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + d.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = n), e = null == e ? [t] : T.makeArray(e, [t]), u = T.event.special[p] || {}, i || !u.trigger || !1 !== u.trigger.apply(n, e))) {
          if (!i && !u.noBubble && !g(n)) {
            for (a = u.delegateType || p, De.test(a + p) || (r = r.parentNode); r; r = r.parentNode) f.push(r), s = r;
            s === (n.ownerDocument || E) && f.push(s.defaultView || s.parentWindow || C)
          }
          for (o = 0;
            (r = f[o++]) && !t.isPropagationStopped();) h = r, t.type = 1 < o ? a : u.bindType || p, (c = (Q.get(r, "events") || Object.create(null))[t.type] && Q.get(r, "handle")) && c.apply(r, e), (c = l && r[l]) && c.apply && V(r) && (t.result = c.apply(r, e), !1 === t.result && t.preventDefault());
          return t.type = p, i || t.isDefaultPrevented() || u._default && !1 !== u._default.apply(f.pop(), e) || !V(n) || l && y(n[p]) && !g(n) && ((s = n[l]) && (n[l] = null), T.event.triggered = p, t.isPropagationStopped() && h.addEventListener(p, Ne), n[p](), t.isPropagationStopped() && h.removeEventListener(p, Ne), T.event.triggered = void 0, s && (n[l] = s)), t.result
        }
      },
    ...
    Qe.href = Ae.href, T.extend({
      ...
      ajax: function(t, e) {
        ...
        var u, h, f, n, p, i, d, g, o, r, m = T.ajaxSetup({}, e),
          ...
          x = {
            ...
            getResponseHeader: function(t) {
              ...
              if (d) {
                if (!n)
                  for (n = {}; e = We.exec(f);) n[e[1].toLowerCase() + " "] = (n[e[1].toLowerCase() + " "] || []).concat(e[2]);
                e = n[t.toLowerCase() + " "]
              }
        ...
        if (y.promise(x), m.url = ((t || m.url || Ae.href) + "").replace(Ue, Ae.protocol + "//"), m.type = e.method || e.type || m.method || m.type, m.dataTypes = (m.dataType || "*").toLowerCase().match(L) || [""], null == m.crossDomain) {
          i = E.createElement("a");
          try {
        ...
        if (m.data && m.processData && "string" != typeof m.data && (m.data = T.param(m.data, m.traditional)), Ke(Ye, m, e, x), d) return x;
        ...
        if (l = "abort", _.add(m.complete), x.done(m.success), x.fail(m.error), u = Ke(Ve, m, e, x)) {
        ...
        function c(t, e, n, i) {
          ...
          }(m, x, n)), !o && -1 < T.inArray("script", m.dataTypes) && (m.converters["text script"] = function() {}), a = function(t, e, n, i) {
            var o, r, s, a, l, c = {},
              u = t.dataTypes.slice();
            if (u[1])
    ...
    b.cors = !!Ze && "withCredentials" in Ze, b.ajax = Ze = !!Ze, T.ajaxTransport(function(o) {
      var r, s;
      if (b.cors || Ze && !o.crossDomain) return {
        send: function(t, e) {
          var n, i = o.xhr();
    ...
    T.ajaxSetup({
      ...
      if (s || "jsonp" === t.dataTypes[0]) return i = t.jsonpCallback = y(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s].replace(nn, "$1" + i) : !1 !== t.jsonp && (t.url += (Oe.test(t.url) ? "&" : "?") + t.jsonp + "=" + i), t.converters["script json"] = function() {
        return r || T.error(i + " was not called"), r[0]
      }, t.dataTypes[0] = "json", o = C[i], C[i] = function() {
        r = arguments
      }, n.always(function() {
        void 0 === o ? T(C).removeProp(i) : C[i] = o, t[i] && (t.jsonpCallback = e.jsonpCallback, en.push(i)), r && y(o) && o(r[0]), r = o = void 0
      }), "script"
    }), b.createHTMLDocument = ((tn = E.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === tn.childNodes.length), T.parseHTML = function(t, e, n) {
      return "string" != typeof t ? [] : ("boolean" == typeof e && (n = e, e = !1), e || (b.createHTMLDocument ? ((i = (e = E.implementation.createHTMLDocument("")).createElement("base")).href = E.location.href, e.head.appendChild(i)) : e = E), r = !n && [], (o = k.exec(t)) ? [e.createElement(o[1])] : (o = bt([t], e, r), r && r.length && T(r).remove(), T.merge([], o.childNodes)));
      var i, o, r
    }, T.fn.load = function(t, e, n) {
      var i, o, r, s = this,
        a = t.indexOf(" ");
      return -1 < a && (i = Te(t.slice(a)), t = t.slice(0, a)), y(e) ? (n = e, e = void 0) : e && "object" == typeof e && (o = "POST"), 0 < s.length && T.ajax({
        url: t,
        type: o || "GET",
        dataType: "html",
        data: e
      ...
      T.cssHooks[n] = Gt(b.pixelPosition, function(t, e) {
        if (e) return e = Kt(t, n), Yt.test(e) ? T(t).position()[n] + "px" : e
      })
    }), T.each({
      Height: "height",
      Width: "width"
    ...
    }, T.isArray = Array.isArray, T.parseJSON = JSON.parse, T.nodeName = S, T.isFunction = y, T.isWindow = g, T.camelCase = Y, T.type = w, T.now = Date.now, T.isNumeric = function(t) {
      var e = T.type(t);
  ...
  function(t) {
    ...
    var u, h, p, d, g, m, v, b, _, w, x, C, E, T, S, k, P, N, D, A, I = "ui-effects-",
      O = y;
    ...
    y.effects = {
      ...
      restore: function(t, e) {
        var n, i;
        for (i = 0; i < e.length; i++) null !== e[i] && (void 0 === (n = t.data(I + e[i])) && (n = ""), t.css(e[i], n))
      },
      ...
      show: (D = y.fn.show, function(t) {
        if (R(t)) return D.apply(this, arguments);
        var e = q.apply(this, arguments);
        return e.mode = "show", this.effect.call(this, e)
      }),
      hide: (N = y.fn.hide, function(t) {
        if (R(t)) return N.apply(this, arguments);
        var e = q.apply(this, arguments);
        return e.mode = "hide", this.effect.call(this, e)
      }),
      toggle: (P = y.fn.toggle, function(t) {
        if (R(t) || "boolean" == typeof t) return P.apply(this, arguments);
        var e = q.apply(this, arguments);
    ...
    }), A = {}, y.each(["Quad", "Cubic", "Quart", "Quint", "Expo"], function(e, t) {
      A[t] = function(t) {
  ...
  function(t, e) {
    ...
    function A(t, e, n) {
      ...
      var i = N(t),
        ...
        l = r ? "height" : "width",
        c = r ? "width" : "height";
      return o[s] = e[s] + e[l] / 2 - i[l] / 2, o[a] = n === a ? e[a] - i[c] : e[D(a)], o
    }
        ...
        modifiers: {
          ...
          offset: {
            ...
            fn: function(t, e) {
              var n = e.offset,
                ...
                a = i.split("-")[0],
                l = void 0;
              return l = R(+n) ? [+n, 0] : $(n, r, s, a), "left" === a ? (r.top += l[0], r.left -= l[1]) : "right" === a ? (r.top += l[0], r.left += l[1]) : "top" === a ? (r.left += l[0], r.top -= l[1]) : "bottom" === a && (r.left += l[0], r.top += l[1]), t.popper = r, t
            },
            offset: 0
          },
          preventOverflow: {
          ...
          flip: {
            ...
            fn: function(g, m) {
              ...
              return w.forEach(function(t, e) {
                ...
                }(_)), g.placement = b + (_ ? "-" + _ : ""), g.offsets.popper = C({}, g.offsets.popper, A(g.instance.popper, g.offsets.reference, g.placement)), g = O(g.instance.modifiers, g, "flip"))
              }), g
            },
            behavior: "flip",
            padding: 5,
          ...
          inner: {
            ...
            fn: function(t) {
              ...
              return o[s ? "left" : "top"] = r[n] - (a ? o[s ? "width" : "height"] : 0), t.placement = D(e), t.offsets.popper = E(o), t
            }
          },
          hide: {
            order: 800,
        ...
        value: function() {
          return function() {
            if (!this.state.isDestroyed) {
              ...
              t.offsets.reference = P(this.state, this.popper, this.reference, this.options.positionFixed), t.placement = u(this.options.placement, t.offsets.reference, this.popper, this.reference, this.options.modifiers.flip.boundariesElement, this.options.modifiers.flip.padding), t.originalPlacement = t.placement, t.positionFixed = this.options.positionFixed, t.offsets.popper = A(this.popper, t.offsets.reference, t.placement), t.offsets.popper.position = this.options.positionFixed ? "fixed" : "absolute", t = O(this.modifiers, t), this.state.isCreated ? this.options.onUpdate(t) : (this.state.isCreated = !0, this.options.onCreate(t))
            }
          }.call(this)
        }
      }, {
  ...
  function(t, e) {
    ...
    d = d && Object.prototype.hasOwnProperty.call(d, "default") ? d.default : d, h = h && Object.prototype.hasOwnProperty.call(h, "default") ? h.default : h;
    var e = "transitionend";
    ...
    g.jQueryDetection(), d.fn.emulateTransitionEnd = n, d.event.special[g.TRANSITION_END] = {
      bindType: e,
      delegateType: e,
      handle: function(t) {
      ...
      c = function() {
        ...
        return t.close = function(t) {
          ...
          var e = g.getSelectorFromElement(t),
            n = !1;
          return e && (n = document.querySelector(e)), n || (n = d(t).closest(".alert")[0]), n
        }, t._triggerCloseEvent = function(t) {
          var e = d.Event("close.bs.alert");
          return d(t).trigger(e), e
        }, t._removeElement = function(e) {
          var n = this;
          if (d(e).removeClass("show"), d(e).hasClass("fade")) {
    ...
    d(document).on("click.bs.alert.data-api", '[data-dismiss="alert"]', c._handleDismiss(new c)), d.fn[o] = c._jQueryInterface, d.fn[o].Constructor = c, d.fn[o].noConflict = function() {
      return d.fn[o] = a, c._jQueryInterface
    };
    var u = "button",
      f = "bs.button",
      p = d.fn[u],
            ...
            if (i) {
              if ("radio" === i.type)
                if (i.checked && this._element.classList.contains(m)) t = !1;
                  ...
                  o && d(o).removeClass(m)
                } t && ("checkbox" !== i.type && "radio" !== i.type || (i.checked = !this._element.classList.contains(m)), d(i).trigger("change")), i.focus(), e = !1
            }
          }
          this._element.hasAttribute("disabled") || this._element.classList.contains("disabled") || (e && this._element.setAttribute("aria-pressed", !this._element.classList.contains(m)), t && d(this._element).toggleClass(m))
        }, t.dispose = function() {
          d.removeData(this._element, f), this._element = null
        }, n._jQueryInterface = function(e) {
          return this.each(function() {
            var t = d(this).data(f);
            t || (t = new n(this), d(this).data(f, t)), "toggle" === e && t[e]()
          })
        }, s(n, null, [{
          key: "VERSION",
          get: function() {
    ...
    d(document).on("click.bs.button.data-api", v, function(t) {
      var e = t.target,
        n = e;
      if (d(e).hasClass("btn") || (e = d(e).closest(".btn")[0]), !e || e.hasAttribute("disabled") || e.classList.contains("disabled")) t.preventDefault();
      else {
    ...
    }), d.fn[u] = y._jQueryInterface, d.fn[u].Constructor = y, d.fn[u].noConflict = function() {
      return d.fn[u] = p, y._jQueryInterface
    };
    var _ = "carousel",
      w = "bs.carousel",
      x = "." + w,
      ...
      I = function() {
        ...
        return t.next = function() {
          ...
          if (!(t > this._items.length - 1 || t < 0))
            if (this._isSliding) d(this._element).one(P, function() {
              return e.to(t)
            });
            else {
          ...
          d(this._element).off(x), d.removeData(this._element, w), this._items = null, this._config = null, this._element = null, this._interval = null, this._isPaused = null, this._isSliding = null, this._activeElement = null, this._indicatorsElement = null
        }, t._getConfig = function(t) {
          return t = l({}, E, t), g.typeCheckConfig(_, t, T), t
          ...
          if (o = t === S ? (n = "carousel-item-left", i = "carousel-item-next", "left") : (n = "carousel-item-right", i = "carousel-item-prev", "right"), l && d(l).hasClass(N)) this._isSliding = !1;
            ...
            if (d(this._element).hasClass("slide")) {
              ...
              d(s).one(g.TRANSITION_END, function() {
                d(l).removeClass(n + " " + i).addClass(N), d(s).removeClass(N + " " + i + " " + n), r._isSliding = !1, setTimeout(function() {
                  return d(r._element).trigger(h)
                }, 0)
              }).emulateTransitionEnd(p)
            } else d(s).removeClass(N), d(l).addClass(N), this._isSliding = !1, d(this._element).trigger(h);
            u && this.cycle()
          }
          ...
          return this.each(function() {
            ...
            if (t || (t = new r(this, e), d(this).data(w, t)), "number" == typeof i) t.to(i);
          ...
          if (e) {
            ...
            if (n && d(n).hasClass("carousel")) {
              ...
              o && (i.interval = !1), r._jQueryInterface.call(d(n), i), o && d(n).data(w).to(o), t.preventDefault()
            }
          }
        }, s(r, null, [{
          key: "VERSION",
    ...
    d(document).on("click.bs.carousel.data-api", "[data-slide], [data-slide-to]", I._dataApiClickHandler), d(window).on("load.bs.carousel.data-api", function() {
      ...
      return d.fn[_] = C, I._jQueryInterface
    };
    var O = "collapse",
      L = "bs.collapse",
      j = d.fn[O],
      ...
      z = function() {
        ...
        return t.toggle = function() {
          ...
          if (!this._isTransitioning && !d(this._element).hasClass(q) && (this._parent && 0 === (t = [].slice.call(this._parent.querySelectorAll(".show, .collapsing")).filter(function(t) {
            ...
            })).length && (t = null), !(t && (e = d(t).not(this._selector).data(L)) && e._isTransitioning))) {
            var i = d.Event("show.bs.collapse");
            if (d(this._element).trigger(i), !i.isDefaultPrevented()) {
              t && (a._jQueryInterface.call(d(t).not(this._selector), "hide"), e || d(t).data(L, null));
              var o = this._getDimension();
              d(this._element).removeClass(R).addClass(B), this._element.style[o] = 0, this._triggerArray.length && d(this._triggerArray).removeClass(F).attr("aria-expanded", !0), this.setTransitioning(!0);
              var r = "scroll" + (o[0].toUpperCase() + o.slice(1)),
                s = g.getTransitionDurationFromElement(this._element);
              d(this._element).one(g.TRANSITION_END, function() {
                d(n._element).removeClass(B).addClass(R + " " + q), n._element.style[o] = "", n.setTransitioning(!1), d(n._element).trigger("shown.bs.collapse")
          ...
          if (!this._isTransitioning && d(this._element).hasClass(q)) {
            ...
            if (d(this._element).trigger(e), !e.isDefaultPrevented()) {
              ...
              this._element.style[n] = this._element.getBoundingClientRect()[n] + "px", g.reflow(this._element), d(this._element).addClass(B).removeClass(R + " " + q);
              var i = this._triggerArray.length;
              if (0 < i)
                for (var o = 0; o < i; o++) {
                  var r = this._triggerArray[o],
                    s = g.getSelectorFromElement(r);
                  if (null !== s) d([].slice.call(document.querySelectorAll(s))).hasClass(q) || d(r).addClass(F).attr("aria-expanded", !1)
                }
              this.setTransitioning(!0);
              this._element.style[n] = "";
              var a = g.getTransitionDurationFromElement(this._element);
              d(this._element).one(g.TRANSITION_END, function() {
                t.setTransitioning(!1), d(t._element).removeClass(B).addClass(R).trigger("hidden.bs.collapse")
          ...
          d.removeData(this._element, L), this._config = null, this._parent = null, this._element = null, this._triggerArray = null, this._isTransitioning = null
        }, t._getConfig = function(t) {
          return (t = l({}, H, t)).toggle = Boolean(t.toggle), g.typeCheckConfig(O, t, M), t
          ...
          return this.each(function() {
            ...
            if (!e && n.toggle && "string" == typeof i && /show|hide/.test(i) && (n.toggle = !1), e || (e = new a(this, n), t.data(L, e)), "string" == typeof i) {
    ...
    }), d.fn[O] = z._jQueryInterface, d.fn[O].Constructor = z, d.fn[O].noConflict = function() {
      return d.fn[O] = j, z._jQueryInterface
    };
    var U = "dropdown",
      Y = "bs.dropdown",
      V = "." + Y,
      ...
      at = function() {
        ...
        return t.toggle = function() {
          ...
          if (void 0 === t && (t = !1), !(this._element.disabled || d(this._element).hasClass(tt) || d(this._menu).hasClass(et))) {
            var e = {
            ...
            if (d(i).trigger(n), !n.isDefaultPrevented()) {
              if (!this._inNavbar && t) {
                ...
                var o = this._element;
                "parent" === this._config.reference ? o = i : g.isElement(this._config.reference) && (o = this._config.reference, void 0 !== this._config.reference.jquery && (o = this._config.reference[0])), "scrollParent" !== this._config.boundary && d(i).addClass("position-static"), this._popper = new h(o, this._menu, this._getPopperConfig())
              }
              "ontouchstart" in document.documentElement && 0 === d(i).closest(".navbar-nav").length && d(document.body).children().on("mouseover", null, d.noop), this._element.focus(), this._element.setAttribute("aria-expanded", !0), d(this._menu).toggleClass(et), d(i).toggleClass(et).trigger(d.Event("shown.bs.dropdown", e))
            }
          }
        }, t.hide = function() {
          if (!this._element.disabled && !d(this._element).hasClass(tt) && d(this._menu).hasClass(et)) {
            ...
            d(n).trigger(e), e.isDefaultPrevented() || (this._popper && this._popper.destroy(), d(this._menu).toggleClass(et), d(n).toggleClass(et).trigger(d.Event(G, t)))
          }
        }, t.dispose = function() {
          d.removeData(this._element, Y), d(this._element).off(V), this._element = null, (this._menu = null) !== this._popper && (this._popper.destroy(), this._popper = null)
        }, t.update = function() {
          ...
          return t = l({}, this.constructor.Default, d(this._element).data(), t), g.typeCheckConfig(U, t, this.constructor.DefaultType), t
          ...
          var t = d(this._element.parentNode),
            e = "bottom-start";
          return t.hasClass("dropup") ? e = d(this._menu).hasClass(nt) ? "top-end" : "top-start" : t.hasClass("dropright") ? e = "right-start" : t.hasClass("dropleft") ? e = "left-start" : d(this._menu).hasClass(nt) && (e = "bottom-end"), e
          ...
          return this.each(function() {
            var t = d(this).data(Y);
            if (t || (t = new c(this, "object" == typeof e ? e : null), d(this).data(Y, t)), "string" == typeof e) {
            ...
            for (var e = [].slice.call(document.querySelectorAll(it)), n = 0, i = e.length; n < i; n++) {
              ...
              if (t && "click" === t.type && (s.clickEvent = t), r) {
                ...
                if (d(o).hasClass(et) && !(t && ("click" === t.type && /input|textarea/i.test(t.target.tagName) || "keyup" === t.type && 9 === t.which) && d.contains(o, t.target))) {
                  var l = d.Event(K, s);
                  d(o).trigger(l), l.isDefaultPrevented() || ("ontouchstart" in document.documentElement && d(document.body).children().off("mouseover", null, d.noop), e[n].setAttribute("aria-expanded", "false"), r._popper && r._popper.destroy(), d(a).removeClass(et), d(o).removeClass(et).trigger(d.Event(G, s)))
                }
              }
            }
          ...
          if ((/input|textarea/i.test(t.target.tagName) ? !(32 === t.which || 27 !== t.which && (40 !== t.which && 38 !== t.which || d(t.target).closest(ot).length)) : $.test(t.which)) && !this.disabled && !d(this).hasClass(tt)) {
            var e = c._getParentFromElement(this),
              n = d(e).hasClass(et);
            if (n || 27 !== t.which) {
              if (t.preventDefault(), t.stopPropagation(), !n || n && (27 === t.which || 32 === t.which)) return 27 === t.which && d(e.querySelector(it)).trigger("focus"), void d(this).trigger("click");
    ...
    d(document).on(Z, it, at._dataApiKeydownHandler).on(Z, ot, at._dataApiKeydownHandler).on(J + " keyup.bs.dropdown.data-api", at._clearMenus).on(J, it, function(t) {
      t.preventDefault(), t.stopPropagation(), at._jQueryInterface.call(d(this), "toggle")
    }).on(J, ".dropdown form", function(t) {
      t.stopPropagation()
    }), d.fn[U] = at._jQueryInterface, d.fn[U].Constructor = at, d.fn[U].noConflict = function() {
      return d.fn[U] = Q, at._jQueryInterface
    };
    var lt = "modal",
      ct = "bs.modal",
      ut = "." + ct,
      ...
      kt = function() {
        ...
        return t.toggle = function(t) {
          ...
          if (!this._isShown && !this._isTransitioning) {
            ...
            d(this._element).trigger(n), this._isShown || n.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), this._adjustDialog(), this._setEscapeEvent(), this._setResizeEvent(), d(this._element).on(bt, '[data-dismiss="modal"]', function(t) {
              return e.hide(t)
          ...
          if (t && t.preventDefault(), this._isShown && !this._isTransitioning) {
            ...
            if (d(this._element).trigger(n), this._isShown && !n.isDefaultPrevented()) {
              ...
              if (i && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), d(document).off(mt), d(this._element).removeClass(Ct), d(this._element).off(bt), d(this._dialog).off(_t), i) {
          ...
          [window, this._element, this._dialog].forEach(function(t) {
            return d(t).off(ut)
          }), d(document).off(mt), d.removeData(this._element, ct), this._config = null, this._element = null, this._dialog = null, this._backdrop = null, this._isShown = null, this._isBodyOverflowing = null, this._ignoreBackdropClick = null, this._isTransitioning = null, this._scrollbarWidth = null
        }, t.handleUpdate = function() {
          this._adjustDialog()
        }, t._getConfig = function(t) {
          return t = l({}, ft, t), g.typeCheckConfig(lt, t, pt), t
          ...
          if ("static" === this._config.backdrop) {
            ...
            n || (this._element.style.overflowY = "hidden"), this._element.classList.add(Et);
            var i = g.getTransitionDurationFromElement(this._dialog);
            d(this._element).off(g.TRANSITION_END), d(this._element).one(g.TRANSITION_END, function() {
              t._element.classList.remove(Et), n || d(t._element).one(g.TRANSITION_END, function() {
          ...
          this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element), this._element.style.display = "block", this._element.removeAttribute("aria-hidden"), this._element.setAttribute("aria-modal", !0), this._element.setAttribute("role", "dialog"), d(this._dialog).hasClass("modal-dialog-scrollable") && i ? i.scrollTop = 0 : this._element.scrollTop = 0, n && g.reflow(this._element), d(this._element).addClass(Ct), this._config.focus && this._enforceFocus();
          ...
          this._element.style.display = "none", this._element.setAttribute("aria-hidden", !0), this._element.removeAttribute("aria-modal"), this._element.removeAttribute("role"), this._isTransitioning = !1, this._showBackdrop(function() {
            d(document.body).removeClass(wt), t._resetAdjustments(), t._resetScrollbar(), d(t._element).trigger(dt)
          })
          ...
          if (this._isShown && this._config.backdrop) {
            if (this._backdrop = document.createElement("div"), this._backdrop.className = "modal-backdrop", n && this._backdrop.classList.add(n), d(this._backdrop).appendTo(document.body), d(this._element).on(bt, function(t) {
                e._ignoreBackdropClick ? e._ignoreBackdropClick = !1 : t.target === t.currentTarget && e._triggerBackdropTransition()
              }), n && g.reflow(this._backdrop), d(this._backdrop).addClass(Ct), !t) return;
            if (!n) return void t();
          ...
          return this.each(function() {
            ...
            if (t || (t = new o(this, e), d(this).data(ct, t)), "string" == typeof n) {
              if (void 0 === t[n]) throw new TypeError('No method named "' + n + '"');
              t[n](i)
    ...
    }), d.fn[lt] = kt._jQueryInterface, d.fn[lt].Constructor = kt, d.fn[lt].noConflict = function() {
      return d.fn[lt] = ht, kt._jQueryInterface
    };
      ...
      for (var n = (new window.DOMParser).parseFromString(t, "text/html"), a = Object.keys(s), l = [].slice.call(n.body.querySelectorAll("*")), i = function(t, e) {
          ...
          o.forEach(function(t) {
            ! function(t, e) {
              ...
              if (-1 !== e.indexOf(n)) return -1 === Pt.indexOf(n) || Boolean(t.nodeValue.match(Dt) || t.nodeValue.match(At));
        ...
        return t.enable = function() {
          ...
          if (this._isEnabled)
            if (t) {
              ...
              if (d(this.getTipElement()).hasClass(Vt)) return void this._leave(null, this);
          ...
          if (this.isWithContent() && this._isEnabled) {
            ...
            o.setAttribute("id", r), this.element.setAttribute("aria-describedby", r), this.setContent(), this.config.animation && d(o).addClass(Yt);
            var s = "function" == typeof this.config.placement ? this.config.placement.call(this, o, this.element) : this.config.placement,
              a = this._getAttachment(s);
            this.addAttachmentClass(a);
            var l = this._getContainer();
            d(o).data(this.constructor.DATA_KEY, this), d.contains(this.element.ownerDocument.documentElement, this.tip) || d(o).appendTo(l), d(this.element).trigger(this.constructor.Event.INSERTED), this._popper = new h(this.element, o, this._getPopperConfig(a)), d(o).addClass(Vt), "ontouchstart" in document.documentElement && d(document.body).children().on("mouseover", null, d.noop);
            var c = function() {
          ...
          function e() {
            n._hoverState !== zt && i.parentNode && i.parentNode.removeChild(i), n._cleanTipClass(), n.element.removeAttribute("aria-describedby"), d(n.element).trigger(n.constructor.Event.HIDDEN), null !== n._popper && n._popper.destroy(), t && t()
          }
          var n = this,
            i = this.getTipElement(),
            o = d.Event(this.constructor.Event.HIDE);
          if (d(this.element).trigger(o), !o.isDefaultPrevented()) {
            if (d(i).removeClass(Vt), "ontouchstart" in document.documentElement && d(document.body).children().off("mouseover", null, d.noop), this._activeTrigger.click = !1, this._activeTrigger.focus = !1, this._activeTrigger[Xt] = !1, d(this.tip).hasClass(Yt)) {
          ...
          this.setElementContent(d(t.querySelectorAll(".tooltip-inner")), this.getTitle()), d(t).removeClass("fade show")
        }, t.setElementContent = function(t, e) {
          "object" != typeof e || !e.nodeType && !e.jquery ? this.config.html ? (this.config.sanitize && (e = It(e, this.config.whiteList, this.config.sanitizeFn)), t.html(e)) : t.text(e) : this.config.html ? d(e).parent().is(t) || t.empty().append(e) : t.text(d(e).text())
        }, t.getTitle = function() {
          ...
          this.config.trigger.split(" ").forEach(function(t) {
            ...
            i.element && i.hide()
          }, d(this.element).closest(".modal").on("hide.bs.modal", this._hideModalHandler), this.config.selector ? this.config = l({}, this.config, {
            trigger: "manual",
            selector: ""
          }) : this._fixTitle()
          ...
          var n = this.constructor.DATA_KEY;
          (e = e || d(t.currentTarget).data(n)) || (e = new this.constructor(t.currentTarget, this._getDelegateConfig()), d(t.currentTarget).data(n, e)), t && (e._activeTrigger["focusout" === t.type ? "focus" : Xt] = !1), e._isWithActiveTrigger() || (clearTimeout(e._timeout), e._hoverState = "out", e.config.delay && e.config.delay.hide ? e._timeout = setTimeout(function() {
          ...
          return Object.keys(e).forEach(function(t) {
            ...
            show: t.delay,
            hide: t.delay
          }), "number" == typeof t.title && (t.title = t.title.toString()), "number" == typeof t.content && (t.content = t.content.toString()), g.typeCheckConfig(Ot, t, this.constructor.DefaultType), t.sanitize && (t.template = It(t.template, t.whiteList, t.sanitizeFn)), t
          ...
          null === t.getAttribute("x-placement") && (d(t).removeClass(Yt), this.config.animation = !1, this.hide(), this.show(), this.config.animation = e)
        }, i._jQueryInterface = function(n) {
          return this.each(function() {
            var t = d(this).data(Lt),
              e = "object" == typeof n && n;
            if ((t || !/dispose|hide/.test(n)) && (t || (t = new i(this, e), d(this).data(Lt, t)), "string" == typeof n)) {
              if (void 0 === t[n]) throw new TypeError('No method named "' + n + '"');
              t[n]()
            }
          })
    ...
    d.fn[Ot] = Qt._jQueryInterface, d.fn[Ot].Constructor = Qt, d.fn[Ot].noConflict = function() {
      return d.fn[Ot] = Ht, Qt._jQueryInterface
    };
    var $t = "popover",
      Kt = "bs.popover",
      Gt = "." + Kt,
      ...
      oe = function(t) {
        ...
        return e.isWithContent = function() {
          ...
          return this.each(function() {
            ...
            if ((t || !/dispose|hide/.test(n)) && (t || (t = new i(this, e), d(this).data(Kt, t)), "string" == typeof n)) {
              if (void 0 === t[n]) throw new TypeError('No method named "' + n + '"');
              t[n]()
            }
          })
    ...
    d.fn[$t] = oe._jQueryInterface, d.fn[$t].Constructor = oe, d.fn[$t].noConflict = function() {
      return d.fn[$t] = Jt, oe._jQueryInterface
    };
    var re = "scrollspy",
      se = "bs.scrollspy",
      ae = "." + se,
      ...
      ge = function() {
        function n(t, e) {
          var n = this;
          this._element = t, this._scrollElement = "BODY" === t.tagName ? window : t, this._config = this._getConfig(e), this._selector = this._config.target + " " + pe + "," + this._config.target + " " + de + "," + this._config.target + " .dropdown-item", this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, d(this._scrollElement).on("scroll.bs.scrollspy", function(t) {
            return n._process(t)
        ...
        return t.refresh = function() {
          ...
          d.removeData(this._element, se), d(this._scrollElement).off(ae), this._element = null, this._scrollElement = null, this._config = null, this._selector = null, this._offsets = null, this._targets = null, this._activeTarget = null, this._scrollHeight = null
        }, t._getConfig = function(t) {
          if ("string" != typeof(t = l({}, ce, "object" == typeof t && t ? t : {})).target && g.isElement(t.target)) {
            var e = d(t.target).attr("id");
            e || (e = g.getUID(re), d(t.target).attr("id", e)), t.target = "#" + e
          }
          return g.typeCheckConfig(re, t, ue), t
          ...
          n.hasClass("dropdown-item") ? (n.closest(".dropdown").find(".dropdown-toggle").addClass(he), n.addClass(he)) : (n.addClass(he), n.parents(fe).prev(pe + ", " + de).addClass(he), n.parents(fe).prev(".nav-item").children(pe).addClass(he)), d(this._scrollElement).trigger("activate.bs.scrollspy", {
            relatedTarget: e
          })
        }, t._clear = function() {
          ...
          return this.each(function() {
            ...
            if (t || (t = new n(this, "object" == typeof e && e), d(this).data(se, t)), "string" == typeof e) {
              if (void 0 === t[e]) throw new TypeError('No method named "' + e + '"');
              t[e]()
            }
          })
    ...
    }), d.fn[re] = ge._jQueryInterface, d.fn[re].Constructor = ge, d.fn[re].noConflict = function() {
      return d.fn[re] = le, ge._jQueryInterface
    };
    var me = "bs.tab",
      ve = d.fn.tab,
      be = "active",
      ...
      _e = function() {
        ...
        return t.show = function() {
          ...
          if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && d(this._element).hasClass(be) || d(this._element).hasClass("disabled"))) {
            var t, i, e = d(this._element).closest(".nav, .list-group")[0],
          ...
          d.removeData(this._element, me), this._element = null
          ...
          if (e) {
            ...
            i && d(i).removeClass(be), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !1)
          }
          if (d(t).addClass(be), "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !0), g.reflow(t), t.classList.contains("fade") && t.classList.add("show"), t.parentNode && d(t.parentNode).hasClass("dropdown-menu")) {
          ...
          return this.each(function() {
            var t = d(this),
              e = t.data(me);
            if (e || (e = new i(this), t.data(me, e)), "string" == typeof n) {
    ...
    d(document).on("click.bs.tab.data-api", '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', function(t) {
      t.preventDefault(), _e._jQueryInterface.call(d(this), "show")
    }), d.fn.tab = _e._jQueryInterface, d.fn.tab.Constructor = _e, d.fn.tab.noConflict = function() {
      return d.fn.tab = ve, _e._jQueryInterface
    };
    var we = "toast",
      xe = "bs.toast",
      Ce = "." + xe,
      ...
      Ne = function() {
        ...
        return t.show = function() {
          ...
          if (d(this._element).trigger(e), !e.isDefaultPrevented()) {
            ...
            var n = function() {
              t._element.classList.remove("showing"), t._element.classList.add(Se), d(t._element).trigger("shown.bs.toast"), t._config.autohide && (t._timeout = setTimeout(function() {
                t.hide()
              }, t._config.delay))
            };
          ...
          this._clearTimeout(), this._element.classList.contains(Se) && this._element.classList.remove(Se), d(this._element).off(Te), d.removeData(this._element, xe), this._element = null, this._config = null
        }, t._getConfig = function(t) {
          return t = l({}, Pe, d(this._element).data(), "object" == typeof t && t ? t : {}), g.typeCheckConfig(we, t, this.constructor.DefaultType), t
        }, t._setListeners = function() {
          var t = this;
          ...
          function t() {
            e._element.classList.add("hide"), d(e._element).trigger("hidden.bs.toast")
          }
          var e = this;
          ...
          return this.each(function() {
            var t = d(this),
              e = t.data(xe);
            if (e || (e = new i(this, "object" == typeof n && n), t.data(xe, e)), "string" == typeof n) {
              if (void 0 === e[n]) throw new TypeError('No method named "' + n + '"');
              e[n](this)
            }
          })
    ...
    d.fn[we] = Ne._jQueryInterface, d.fn[we].Constructor = Ne, d.fn[we].noConflict = function() {
      return d.fn[we] = Ee, Ne._jQueryInterface
    }, t.Alert = c, t.Button = y, t.Carousel = I, t.Collapse = z, t.Dropdown = at, t.Modal = kt, t.Popover = oe, t.Scrollspy = ge, t.Tab = _e, t.Toast = Ne, t.Tooltip = Qt, t.Util = g, Object.defineProperty(t, "__esModule", {
      value: !0
    })
  }),
  function(t, e) {
      ...
      slimScroll: function(S) {
        ...
        return this.each(function() {
          ...
          if (f.parent().hasClass(k.wrapperClass)) {
            var p = f.scrollTop();
            if (y = f.siblings("." + k.barClass), b = f.siblings("." + k.railClass), C(), P.isPlainObject(S)) {
            ...
            }), x(0, !0)) : "top" !== k.start && (x(P(k.start).position().top, null, !0), k.alwaysVisible || y.hide()), v = this, window.addEventListener ? (v.addEventListener("DOMMouseScroll", w, !1), v.addEventListener("mousewheel", w, !1)) : document.attachEvent("onmousewheel", w)
          }
          ...
          function w(t) {
            if (i) {
              ...
              P(n).closest("." + k.wrapperClass).is(f.parent()) && x(e, !0), t.preventDefault && !h && t.preventDefault(), h || (t.returnValue = !1)
            }
          }
    ...
    a = "ontouchstart" in n || n.DocumentTouch && t instanceof DocumentTouch ? "click tap" : "click", r.prototype = {
      ...
      _clickEvents: function() {
        ...
        t.on(a, ".js-panel-collapse", function(t) {
          ...
          initApp.playSound(myapp_config.assetsUrl + "/media/sound", "messagebox"), "undefined" != typeof bootbox ? bootbox.confirm({
