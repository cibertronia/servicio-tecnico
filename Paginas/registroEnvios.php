...
$_title = 'Registro Envios ';
$_active_nav = 'registro_envios';
            ...
            <div class="col">
              <div class="panel">
                <div class="panel-hdr">
                  ...
                  <h2><span class="fw-300 text-primary">REGISTRO ENVIOS
                    </span> &nbsp; &nbsp;del &nbsp;
                ...
                <div class="panel-container">
                  <div class="panel-content">
                    <form class="w-75 m-auto d-none" id="buscar" action="?root=registroEnvios" method="POST">
                      <div class="row mb-2">
                          ...
                          <div class="widget widget-stats bg-warning custom-card">
                            ...
                            <div class="stats-info">
                              <h4>COCHABAMBA <?php //echo strtoupper($mes) 
                                              ?></h4>
                              <p><?php
                                  $queryVentas  =  mysqli_query($MySQLi, "SELECT SUM(cb) AS amountTotal FROM historial_stock_envios WHERE (DATE_FORMAT(dateEmission, '%Y-%m-%d') BETWEEN '$Inicio' AND '$Fin') ") or die(mysqli_error($MySQLi));
                          ...
                          <div class="widget widget-stats bg-primary custom-card">
                            ...
                            <div class="stats-info">
                              <h4>LA PAZ <?php //echo strtoupper($mes) 
                                          ?></h4>
                              <p><?php
                                  $queryVentas  =  mysqli_query($MySQLi, "SELECT SUM(lp) AS amountTotal FROM historial_stock_envios WHERE (DATE_FORMAT(dateEmission, '%Y-%m-%d') BETWEEN '$Inicio' AND '$Fin') ") or die(mysqli_error($MySQLi));
                                  $dataVentas    =  mysqli_fetch_assoc($queryVentas);
                                  $TotalVentas   =  $dataVentas['amountTotal'];
                                  $lp = $TotalVentas;
                                  $granTotal = $granTotal + $TotalVentas;
                          ...
                          <div class="widget widget-stats bg-success custom-card">
                            ...
                            <div class="stats-info">
                              <h4>SANTA CRUZ <?php //echo strtoupper($mes) 
                                              ?></h4>
                              <p><?php
                                  $queryVentas  =  mysqli_query($MySQLi, "SELECT SUM(sc) AS amountTotal FROM historial_stock_envios WHERE (DATE_FORMAT(dateEmission, '%Y-%m-%d') BETWEEN '$Inicio' AND '$Fin') ") or die(mysqli_error($MySQLi));
                                  $dataVentas    =  mysqli_fetch_assoc($queryVentas);
                                  $TotalVentas   =  $dataVentas['amountTotal'];
                                  $sc = $TotalVentas;
                                  $granTotal = $granTotal + $TotalVentas;
                          ...
                          <div class="widget widget-stats bg-info custom-card">
                            ...
                            <div class="stats-info">
                              <h4>TARIJA <?php //echo strtoupper($mes) 
                                          ?></h4>
                              <p><?php
                                  $queryVentas  =  mysqli_query($MySQLi, "SELECT SUM(tj) AS amountTotal FROM historial_stock_envios WHERE (DATE_FORMAT(dateEmission, '%Y-%m-%d') BETWEEN '$Inicio' AND '$Fin') ") or die(mysqli_error($MySQLi));
                                  $dataVentas    =  mysqli_fetch_assoc($queryVentas);
                                  $TotalVentas   =  $dataVentas['amountTotal'];
                                  $tj = $TotalVentas;
                                  $granTotal = $granTotal + $TotalVentas;
                        ...
                        <div class="panel-content">
                          <table id="listamisVentas" class="table table-bordered table-hover table-striped w-100">
                            ...
                            <tbody>
                              <?php
                              $Num = 1;
                              $q_historial = mysqli_query($MySQLi, "SELECT * FROM historial_stock_envios WHERE (DATE_FORMAT(dateEmission, '%Y-%m-%d') BETWEEN '$Inicio' AND '$Fin') ");
