...
$_title       = 'Lista de Capacitaciones - '.APP_TITLE;
$_active_nav  = 'lista';?>
<!DOCTYPE html>
<html><?php include_once APP_PATH.'/includes/head.php'; ?>
  <body class="mod-bg-1 mod-nav-link mod-skin-<?= $_theme ?> ">
    ...
    <div class="page-wrapper">
      <div class="page-inner">
        ...
        <div class="page-content-wrapper">
          ...
          <main id="js-page-content" role="main" class="page-content" data-idrango="<?= $_SESSION['idRango'] ?>">
            <ol class="breadcrumb page-breadcrumb"><li class="position-absolute pos-top pos-right d-none d-sm-block"><?=$Fecha ?></li></ol>
            <?php 
            if ($_SESSION['idRango'] == 1 || $_SESSION['idRango'] == 4) {
              echo error403();
            } else {
            ?>
            <div class="mt-3">
    ...
    <?php include_once APP_PATH . '/includes/components/capacitaciones/modalEdition.php'; ?>
