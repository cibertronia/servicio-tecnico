...
$_title = 'Facturación Lista ' . APP_TITLE;
$_active_nav = 'listado';
              ...
              <div class="panel">
                ...
                <div class="panel-container">
                  <div class="panel-content">
                    <form class="w-75 m-auto d-none" id="buscar" action="?root=facturacion_listado" method="POST">
                      <div class="row mb-2">
                                ...
                                <div class="col-xl-3 col-md-6">
                                  <div class="widget widget-stats bg-primary custom-card">
                                    ...
                                    FROM
                                        factura
                                    WHERE
                                        branchId = '$idTiendaDf' AND siatCodeState = 908 AND ( DATE_FORMAT(dateEmission, '%Y-%m-%d') BETWEEN '$Inicio' AND '$Fin' )") or die(mysqli_error($MySQLi));
                                  ...
                                  <div class="widget widget-stats bg-success custom-card">
                                    ...
                                    <div class="stats-info text-white">
                                      ...
                                      <p style="font-size: 18px;"><?php
                                        ...
                                        factura
                                    WHERE
                                        branchId = '$idTiendaDf' AND siatCodeState = 908 AND ( DATE_FORMAT(dateEmission, '%Y-%m-%d') BETWEEN '$Inicio' AND '$Fin' )");
                                  ...
                                  <div class="widget widget-stats bg-danger custom-card">
                                    ...
                                    <div class="stats-info text-white">
                                      ...
                                      <p style="font-size: 18px;"><?php
                                        ...
                                        factura
                                    WHERE
                                        branchId = '$idTiendaDf' AND siatCodeState = 905 AND ( DATE_FORMAT(dateEmission, '%Y-%m-%d') BETWEEN '$Inicio' AND '$Fin' )");
                                  ...
                                  <div class="widget widget-stats bg-info custom-card">
                                    ...
                                    <div class="stats-info text-white">
                                      ...
                                      <p style="font-size: 18px;"><?php
                                          ...
                                          $totalfacturado = 0;
                                          $QueryFactura = mysqli_query($MySQLi, "SELECT* FROM detailInvoice WHERE branchId='$idTiendaDf'  AND( DATE_FORMAT(dateEmission, '%Y-%m-%d') BETWEEN '$Inicio' AND '$Fin' ) ORDER BY invoiceNumber DESC");

                                          while ($data = mysqli_fetch_assoc($QueryFactura)) {

                                            $nroFactura = $data['invoiceNumber'];
                                            $qtyFactura = $data['qty'];
                                            $QueryFacturaCabezera = mysqli_query($MySQLi, "SELECT* FROM factura WHERE branchId='$idTiendaDf' AND invoiceNumber='$nroFactura'  ");
